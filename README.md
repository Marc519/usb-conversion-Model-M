...
The firmware is written for a teensy 4.0 microcontroller and utilises the teensyduino usb library, which should be easy to set up using [this](https://www.pjrc.com/teensy/td_download.html) guide, [this](https://www.pjrc.com/teensy/td_keyboard.html) guide, and the arduino IDE. Once your IDE is set up you should just be able to open keyboard/keyboard.ino in the IDE and press upload.
